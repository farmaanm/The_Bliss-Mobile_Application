...
import com.example.thebliss.databinding.ActivityFlowersBinding
...
class FlowersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        but1.setOnClickListener {
            ...
            val intent = Intent(this,CartActivity::class.java)
            intent.putExtra("ProductName","White flower bunch")
            intent.putExtra("ProductImage","flowers_1")
        ...
        but2.setOnClickListener {
            ...
            val intent = Intent(this,CartActivity::class.java)
            intent.putExtra("ProductName","Blue Orchid Vase")
            intent.putExtra("ProductImage","flowers_4")
            intent.putExtra("ProductPrice","1500")
            startActivity(intent)
